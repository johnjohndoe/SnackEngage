...
public class Dependencies {
    ...
    public static class Libs {
        ...
        public static final String APPCOMPAT = "androidx.appcompat:appcompat:1.7.1"; // minSdk 23 is required as of 1.8.0
        public static final String ASSERTJ = "org.assertj:assertj-core:3.27.7";
        public static final String COORDINATOR_LAYOUT = "androidx.coordinatorlayout:coordinatorlayout:1.3.0";
        public static final String JUNIT = "junit:junit:4.13.2";
        public static final String MATERIAL = "com.google.android.material:material:1.13.0"; // compileSdk 35 is required as of 1.14.0
